...
void Lib::show(int i)
{
  ...
  {
      int i;
      cout<<"\n\t\t>>PLEASE CHOOSE SUBJECT OF MCA(2nd SEM) :-\n";
...
void Lib::pass()
{
    ...
    cout<<"\n\n\n\n\n\t\t\t**######################################**";
    cout<<"\n\t\t\t      WELCOME TO THE PORTAL LIBRARIAN";
    cout<<"\n\t\t\t**######################################**";
    cout<<"\n\n\n\t\tEnter your Password for the login into the portal";
    cout<<"\n\n\n\t\t\t Enter Password : ";
    while(1)
    {
    ch=getch();
...
void Lib::librarian()
{
    int i;
        cout<<"\n\n\t\t\t**################################################**";
        cout<<"\n\t\t\t      WELCOME TO THE BOOKS MANAGMENT MENU PORTAL";
        cout<<"\n\t\t\t**#################################################**";
        cout<<"\n\n\n\t\t>>Please Choose One Option:\n";
        cout<<"\n\n\t\t1.View BookList\n\n\t\t2.Search for a Book\n\n\t\t3.Modify/Add Book\n\n\t\t4.Issue Book\n\n\t\t5.Go to main menu\n\n\t\t6.Change Password\n\n\t\t7.Close Application\n";
        cout<<"\n\t\tEnter your choice : ";
